...
<div class="container">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">All Other Found Pets</li>
        </ol>
    </nav>
</div>
<div class="container py-3">
    ...
    <h1 class="text-center pb-2">All Found Pets</h1>
    <br>
    ...
    <div class="row">
        <div class="col-lg-8 mx-auto">
            ...
            <!-- List group-->
            <ul class="list-group shadow" id="indexCard">
                    ...
                    <div class="media align-items-lg-center flex-column flex-lg-row p-3">
                        ...
                        <div class="media-body order-2 order-lg-2">
                            <a href="{{ route('found.show', $foundPet->id) }}">
                                <h5 class="mt-0 font-weight-bold mb-2">Description: {{ $foundPet->description}}</h5>
                            </a>
