    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6 text-center mb-5">
                <h1 class="heading-section">Report Missing Pet</h1>
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-lg-10">
                        ...
                        <div class="col-md-12 col-lg-12">
                            <div class="contact-wrap w-100 p-md-5 p-4">
                                ...
                                <form style="width:95%" action="{{ route('missing.store') }}" enctype="multipart/form-data" method="POST">
                                    ...
                                    <div class="form-group row">
                                        <label for="petName" class="col-25 col-form-label">Pet Name</label>
                                    ...
                                    <div class="form-group row">
                                        <label for="petAge" class="col-50 col-form-label">Pet Age</label>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="town" class="col-25 col-form-label">Town</label>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="postCode" class="col-25 col-form-label">Post Code (First 3 or 4 digits)</label>
                                    </div>
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <h2>Add up to 2 more photos of your pet</h2>
                                        </p>
                                    </div>
