...
<div class="container">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">All Missing Dogs</li>
        </ol>
    </nav>
</div>
<div class="container py-3">
    ...
    <h1 class="text-center pb-2">All Missing Dogs</h1>
    <br>
                ...
                <li class="list-group-item">
                    ...
                    <div class="media align-items-lg-center flex-column flex-lg-row p-3">
                        ...
                        <div class="media-body order-2 order-lg-2">
                            <a href="#">
                                <h5 class="mt-0 font-weight-bold mb-2">Name: {{ $missingPet->petName}}</h5>
                            </a>
                        ...
                        <a href="#"><img src=" /storage/{{$missingPet->img1}} " alt="Generic placeholder image" class="img-responsive mt-2 mb-2 ml-2 mr-4" style="width: 150px; z-index: 1"></a>
