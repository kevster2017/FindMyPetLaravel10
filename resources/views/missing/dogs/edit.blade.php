...
<div class="container">
    <ul class="breadcrumb">
        <li><a href="/">Home </a></li>
        <li> / Edit Missing Pet</li>
    </ul>
</div>

<div class="container">
    <form action="{{ route('missing.update', $missing->id) }}" enctype="multipart/form-data" method="POST">
        @csrf
        @method('PUT')
        ...
        <h1><label for="reportMissing" class="form-label"><strong>Edit Missing Pet Profile</strong></label></h1>
        ...
        <div class="center mt-5"><button class="btn btn-primary" type="submit">Update</button>
        </div>
