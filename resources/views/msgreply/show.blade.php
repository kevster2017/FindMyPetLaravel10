...
<div class="container py-3">
  ...
  <h1 class="text-center pb-2">Message Replies</h1>
  <br>
    ...
    <div class="col-lg-8 mx-auto">
      ...
      <ul class="list-group shadow">
        ...
        <li class="list-group-item">
          ...
          <!-- End -->
          <div class="button">
            <button type="button" href=" {{ route('MsgReply.create') }} " class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#msgreply">Reply</button>
